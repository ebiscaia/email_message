...
and to translate it to learner's mother tongue.
...
* Modify the `auth.json` adding your email details
...
[CAUTION]
====
The password to be used is the app-specific one and not the email password.
